...
public class ConfigReader {
    ...
    private static double firstColumnPercentWidth;

    // Sets temporary data for now
    public static void readConfig() {
//        ConfigReader.buttonInfo.put(0, new ButtonInfo("Hem", null, null));
        ConfigReader.buttonInfo.put(0, new ButtonInfo("Hem", "https://www.komplett.se/", "kOmmer ändå ej användas"));
        ...
        ConfigReader.bgColor = Color.WHITE;
        ConfigReader.mainText = "Välkommen till Bibliotek X";
        ConfigReader.idleTimeInSeconds = 5;
        ConfigReader.firstColumnPercentWidth = 30.0;
    }
    ...
    public static double getFirstColumnPercentWidth() {
